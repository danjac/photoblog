...
from photoblog.http.request import is_authenticated_request
from photoblog.http.response import RenderOrRedirectResponse, TextResponse
...
def index(request: HttpRequest) -> RenderOrRedirectResponse:
    """Landing page or redirect to photos for authenticated users."""
